        ...
        try {
            ...
            if (dbmd != null) {
                if (dbmd.supportsBatchUpdates()) {
                    logger.log(Level.INFO,"JDBC driver supports batch updates");
                    return true;
                } else {
                    logger.log(Level.INFO,"JDBC driver does not support batch updates");
                }
            }
        } catch (SQLException ex) {
            logger.log(Level.INFO,"JDBC driver 'supportsBatchUpdates' method threw exception", ex);
        } catch (AbstractMethodError err) {
            logger.log(Level.INFO,"JDBC driver does not support JDBC 2.0 'supportsBatchUpdates' method", err);
        }
        return false;
    }
